...
if (isset($_POST['login'])) {
	...
	mysqli_query($conn, "SELECT * FROM username WHERE username = '$username'");
			...
			<div class="row full-height justify-content-center">
				<div class="col-12 text-center align-self-center py-5">
					<div class="section pb-5 pt-5 pt-sm-2 text-center">
						<h4 class="mb-0 pb-3"><span> Absensi Perkuliahan </span></h4>
								...
								<div class="card-back pnl">
									<div class="center-wrap">
										<div class="section text-center">
											...
											<div class="form-group mt-2">
												<input type="tel" class="form-style" placeholder="NRP">
											...
											<button href="#" class="btn mt-4" action="">Register</button>
										</div>
									</div>
								</div>
							</div>
